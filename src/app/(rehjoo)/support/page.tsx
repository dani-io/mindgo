...
const FAQ = [
  {
    ...
    a: 'راه‌بلد یک کوچ حرفه‌ای است که روی رشد، اهداف و مهارت‌های زندگی کار می‌کند. روانپزشک پزشک متخصص است که اختلالات روانی را تشخیص و درمان می‌کند. اگر نشانه‌های بالینی داری، پیش روانپزشک برو؛ برای رشد شخصی، راه‌بلد انتخاب بهتری‌ست.',
  },
  {
    q: 'آیا جلسه اول رایگان است؟',
    a: 'بله! بیشتر راه‌بلدها یک جلسه آشنایی کوتاه (معمولاً ۲۰ دقیقه) رایگان ارائه می‌دهند. پکیج‌های دارای برچسب «شروع آسان» را ببین.',
  },
  {
  ...
  },
  {
    ...
    a: 'بله. تمام مکالمات و اطلاعات شخصی شما تحت پروتکل محرمانگی Mindgo کاملاً محفوظ است. راه‌بلدها نیز قرارداد عدم افشا امضا کرده‌اند.',
  },
]
